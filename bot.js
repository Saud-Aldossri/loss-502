...
client.on('ebnklb',function(ebnklb) {
    ...
    if(ebnklb.content.startsWith("<303197992809267202>")) {
        ebnklb.channel.send('Hey Im **Silver!**  A Nice Bot Developed By:`Loss`')
...
if (command == "warn") {
    ...
    client.channels.get("500295047552696320").send(`**=========================================**`)
    client.channels.get("500295047552696320").send(`**New Warn !**`)
    client.channels.get("500295047552696320").send({embed : say})
    client.channels.get("500295047552696320").send(`**Admin : ${message.author.username}#${message.author.discriminator}**`)
    client.channels.get("500295047552696320").send(`**In Channel : ${message.channel}**`)
    message.delete();
  }
