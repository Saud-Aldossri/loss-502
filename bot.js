...
if(member.voiceChannelID === '494682823102562315') {
...
deny: ['CONNECT']
    ...
    const parent = member.guild.channels.get('494682823102562315').parentID
...
message.guild.members.get(user.id).setVoiceChannel('465327558196461570'); // المكان الي راح ينحطوله بعد ما يصير لهم lock
}  
} catch (error) {
console.log(error)
}
